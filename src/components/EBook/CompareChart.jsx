    ...
    useEffect(() => {
        const fetchAllData = async () => {
            ...
            try {
                ...
                const standard = await getBabyStandard(mappedGender, babyAge);
    ...
    const options = {
        ...
        scales: {
            r: {
                ...
                pointLabels: { color: "#5D5046", font: { size: 12, weight: "800" } },
            },
        },
    };
    ...
    return (
        <div className="compare-chart-inside">
            <h3 className="compare-chart-main-title">
                📈 또래 대비 성장 지표 ({babyAge}개월 / {mappedGender === "F" ? "여아" : "남아"})
            </h3>
            ...
            <div className="compare-stat-rows">
                <div className="comp-row">
                    ...
                    <span className="comp-val">
                        ...
                        <span className={`comp-badge ${myChartData[0] >= 100 ? "badge-up" : "badge-down"}`}>{myChartData[0]}%</span>
                    </span>
                </div>
                <div className="comp-row">
                    ...
                    <span className="comp-val">
                        ...
                        <span className={`comp-badge ${myChartData[1] >= 100 ? "badge-up" : "badge-down"}`}>{myChartData[1]}%</span>
                    </span>
                </div>
                <div className="comp-row">
                    ...
                    <span className="comp-val">
                        ...
                        <span className={`comp-badge ${myChartData[2] >= 100 ? "badge-up" : "badge-down"}`}>{myChartData[2]}%</span>
                    </span>
                </div>
                <div className="comp-row">
                    ...
                    <span className="comp-val">
                        ...
                        <span className={`comp-badge ${myChartData[3] >= 100 ? "badge-up" : "badge-down"}`}>{myChartData[3]}%</span>
                    </span>
                </div>
                <div className="comp-row">
                    ...
                    <span className="comp-val">
                        ...
                        <span className={`comp-badge ${myChartData[4] >= 100 ? "badge-up" : "badge-down"}`}>{myChartData[4]}%</span>
                    </span>
                </div>
            </div>
            <p className="compare-footnote">※ WHO 소아 발달 표준 마스터 가이드를 준수한 수치입니다.</p>
        </div>
    );
}
