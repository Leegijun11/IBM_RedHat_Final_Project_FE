...
function Sign_up({ setPage }) {
    ...
    const [errors, setErrors] = useState({
        ...
        u_phone: "", u_address: "", u_pw: "", confirm_pw: ""
    });

    const [touched, setTouched] = useState({
        u_account: false, u_name: false, u_nickname: false, u_email: false,
        u_phone: false, u_address: false, u_pw: false, confirm_pw: false
    });
            ...
            <div className="bottom-sheet">
                ...
                <form onSubmit={handleSignup}>
                    ...
                    <input
                        ...
                        value={u_name} onChange={(e) => setU_name(e.target.value)}
                    ...
                    <input
                        ...
                        type="text" placeholder="앱에서 표시될 이름"
                        value={u_nickname} onChange={(e) => setU_nickname(e.target.value)}
                    ...
                    <input
                        ...
                        value={u_email} onChange={(e) => setU_email(e.target.value)}
                    ...
                    <input
                        ...
                        type="text" placeholder="전화번호를 입력하세요 ('-' 제외 숫자만)"
                        value={u_phone} onChange={(e) => setU_phone(e.target.value)}
                    ...
                    <input
                        ...
                        value={u_address} onChange={(e) => setU_address(e.target.value)}
                    ...
                    <div className="password-input-wrapper" style={{ position: "relative" }}>
                        <input
                            ...
                            value={u_pw} onChange={(e) => setU_pw(e.target.value)}
                    ...
                    <div className="password-input-wrapper" style={{ position: "relative" }}>
                        <input
                            ...
                            value={confirm_pw} onChange={(e) => setConfirm_pw(e.target.value)}
