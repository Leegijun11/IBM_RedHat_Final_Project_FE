            ...
            <div className="detail-ig-actions">
                <div className="ig-icons-box">
                    <button className={`ig-like-btn ${post.is_liked ? "liked" : ""}`} onClick={handleLikeClick}>
                        <span className="icon">
                            <svg width="19" height="19" viewBox="0 0 24 24" fill={post.is_liked ? "#F07C60" : "none"} stroke={post.is_liked ? "#F07C60" : "currentColor"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
