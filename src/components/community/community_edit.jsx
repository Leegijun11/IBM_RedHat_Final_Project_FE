    ...
    return (
        <div className="community-edit-container">
            <div className="edit-header">
                <h2>
                    게시물 수정
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#F07C60" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ verticalAlign: "-3px", marginLeft: "8px" }}>
